        ...
        {modal && (
          <div className="fixed inset-0 z-[210] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg rounded-3xl border p-6 shadow-2xl backdrop-blur-xl max-h-[88vh] flex flex-col"
            ...
            >
              ...
              {isForm ? (
                <>
                  <h3 className="text-lg font-black text-white mb-4 pr-8" style={{ fontFamily: TYPOGRAPHY.fontFamily.heading }}>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl px-3 py-2.5 mb-2 text-sm font-semibold text-white placeholder:text-white/30 focus:outline-none focus:ring-1 focus:ring-primary/40"
                  ...
                  <textarea
                    ...
                    className="w-full flex-1 min-h-[160px] rounded-2xl p-3 text-sm text-white placeholder:text-white/30 resize-y focus:outline-none focus:ring-1 focus:ring-primary/40"
                    style={{ backgroundColor: `${COLORS.neutralWhite}08`, border: `1px solid ${COLORS.neutralWhite}18` }}
                  />
                ...
                <>
                  <div className="flex items-start gap-3 mb-4 pr-8">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="text-lg font-black text-white leading-tight" style={{ fontFamily: TYPOGRAPHY.fontFamily.heading }}>
                    ...
                    {canEdit && (
                      <button
                        ...
                        className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[11px] font-bold uppercase tracking-wider transition-colors hover:bg-white/10 border"
                  ...
                  <div className="overflow-y-auto flex-1 rounded-2xl border p-4" style={{ backgroundColor: `${COLORS.neutralWhite}05`, borderColor: `${COLORS.neutralWhite}10` }}>
                    <p className="text-[13px] text-white/85 leading-relaxed whitespace-pre-wrap">{modal.note.note}</p>
                  </div>
                </>
              ) : null}
            </motion.div>
