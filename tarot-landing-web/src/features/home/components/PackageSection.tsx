  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <img src={CoverImg} alt="Soul Background" className="w-full h-full object-cover" />
        </motion.div>

        {/* MASKING OVERLAYS */}
        <div className="absolute inset-0 z-10 bg-gradient-to-b from-dark via-dark/70 to-dark" />
        <div className="absolute inset-0 z-10" style={{ background: `radial-gradient(circle at center, transparent 0%, ${COLORS.dark} 90%)` }} />
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] pointer-events-none z-20">
  ...
  />
      ...
      <motion.div style={{ opacity: contentOpacity }} className="max-w-7xl mx-auto relative z-30">
            ...
            >
              ...
              <div 
                className={`relative p-10 rounded-[3rem] border transition-all duration-700 h-full backdrop-blur-3xl overflow-hidden shadow-2xl ${
                  pkg.popular ? 'border-primary/40 bg-white/[0.06]' : 'border-white/5 bg-white/[0.02] group-hover:bg-white/[0.04]'
              ...
              >
                ...
                <div className="relative z-10 mb-8">
                  ...
                  <div className="flex items-baseline gap-1 mb-4">
                    ...
                    <span className="text-white/20 text-xs uppercase tracking-widest font-light">USD</span>
                  </div>
  ...
  whileTap={{ scale: 0.98 }}
  className={`
    relative z-10 w-full py-3 rounded-2xl overflow-hidden
   uppercase  
...
>
  ...
  <span className={`relative z-10 transition-colors duration-500 ${!pkg.popular && 'group-hover/btn:text-dark'}`}>
    {pkg.cta}
  </span>
