"""Raw-byte verification of the eleven Production Lock Version 6 files."""
...
LOCKED_SHA256 = {
    # Production Lock Version 6: owner-authorized pair-scoped Atlas client memory.
    # Versions 1-5 stay preserved in Second Brain.
