  ...
  return (
    <div className="h-screen w-full flex overflow-hidden font-body" style={{ backgroundColor: COLORS.dark }}>
      ...
      >
        ...
        <Link 
          to="/"
          className="absolute top-8 left-8 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
          style={{ 
            backgroundColor: `${COLORS.primary}20`,
            border: `1px solid ${COLORS.primary}40`,
          }}
        >
          <Icon icon="ph:eye-bold" className="text-2xl" style={{ color: COLORS.primary }} />
        </Link>
