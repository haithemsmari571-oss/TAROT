      ...
      >
        <div className="max-w-[360px] w-full mx-auto">
          <header className="space-y-4 mb-10">
            ...
            >
              New <br /> <span style={{ color: COLORS.primary }}>Cipher</span>
            </h1>
          ...
          {isSuccess ? (
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <label className="text-[9px] font-black uppercase tracking-widest text-white/50 ml-1">New Password</label>
              ...
              <div className="space-y-2">
                <label className="text-[9px] font-black uppercase tracking-widest text-white/50 ml-1">Confirm Password</label>
                <div className="relative">
                  <Icon icon="ph:lock-key-bold" className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 text-lg" />
                  <input 
                    required 
